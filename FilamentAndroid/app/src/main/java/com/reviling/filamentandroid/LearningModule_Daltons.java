...
public class LearningModule_Daltons extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.learning_module_daltons); // Update to your correct XML file for Concept screen
