...
public class SplashScreenMysteryDoor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.splash_mystery_door);
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                Intent intent = new Intent(SplashScreenMysteryDoor.this, Atomu_MysteryDoorGameIntro.class);
