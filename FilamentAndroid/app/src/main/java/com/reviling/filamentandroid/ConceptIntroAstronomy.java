...
public class ConceptIntroAstronomy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.concept_intro_astronomy); // Update to your correct XML file for Concept screen
