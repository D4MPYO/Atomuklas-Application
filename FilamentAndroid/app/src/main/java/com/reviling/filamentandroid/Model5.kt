...
class Model5 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.model_3d_5)
    ...
    private fun initializeViewer() {
        customViewer.run {
            ...
            loadGlb(this@Model5, "sample", "nuclear")
            loadIndirectLight(this@Model5, "venetian_crossroads_2k")
        }
    }
