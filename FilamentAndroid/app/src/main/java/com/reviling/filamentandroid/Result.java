...
public class Result extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (correctAnswers == totalQuestions && totalQuestions != 0) {
            imageView5.setImageResource(R.drawable.badge_exam); // optional trophy image
            ...
            badgeEditor.putBoolean("badge_exam_unlocked", true);
            badgeEditor.apply();
        ...
        int highestCorrectAnswers = sharedPreferences.getInt("highestCorrectAnswersExam", 0);
        int highestTotalQuestions = sharedPreferences.getInt("highestTotalQuestionsExam", 0);
...
// Check if the current score is higher, and only update if true
        if (correctAnswers > highestCorrectAnswers ||
            ...
            editor.putInt("highestCorrectAnswersExam", correctAnswers);
            editor.putInt("highestTotalQuestionsExam", totalQuestions);
            editor.apply();
        }
    ...
    private void setupButtonListeners(int correctAnswers, int wrongAnswers, String timeSpent) {
        ...
        reviewAnswer.setOnClickListener(v -> {
            if (getIntent().hasExtra("questions") &&
                ...
                Intent reviewIntent = new Intent(Result.this, ReviewAnswersActivityEasy.class);
