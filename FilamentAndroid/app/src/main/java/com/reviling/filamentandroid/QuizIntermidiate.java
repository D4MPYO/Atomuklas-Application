...
public class QuizIntermidiate extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.quiz_intermediate);
        ...
        if (takeExamButton != null) {
            ...
            takeExamButton.setOnClickListener(v -> {
                Intent intent = new Intent(QuizIntermidiate.this, StartIntermediateQuiz.class);
