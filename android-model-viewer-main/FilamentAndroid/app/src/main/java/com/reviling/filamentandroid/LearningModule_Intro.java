...
public class LearningModule_Intro extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.learning_module_introduction); // Update to your correct XML file for Concept screen
