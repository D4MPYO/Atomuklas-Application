...
public class ResultEasy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (correctAnswers == totalQuestions && totalQuestions != 0) {
            imageView5.setImageResource(R.drawable.badge_easy); // optional trophy image
            ...
            badgeEditor.putBoolean("badge_easy_unlocked", true);
            badgeEditor.apply();
        ...
        int highestTotalQuestions = sharedPreferences.getInt("highestTotalQuestionsEasy", 0);
...
// Check if the current score is higher, and only update if true
        if (correctAnswers > highestCorrectAnswers ||
            ...
            editor.putInt("highestCorrectAnswersEasy", correctAnswers);
            editor.putInt("highestTotalQuestionsEasy", totalQuestions);
            editor.apply();
        }
    ...
    private void setupButtonListeners(int correctAnswers, int wrongAnswers, String timeSpent) {
        backHomeButton.setOnClickListener(v -> {
            startActivity(new Intent(ResultEasy.this, MainActivity.class));
            finish();
        });
        ...
        reviewAnswer.setOnClickListener(v -> {
            if (getIntent().hasExtra("questions") &&
                ...
                Intent reviewIntent = new Intent(ResultEasy.this, ReviewAnswersActivityEasy.class);
