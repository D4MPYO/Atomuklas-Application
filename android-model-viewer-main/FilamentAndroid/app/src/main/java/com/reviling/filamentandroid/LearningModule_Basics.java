...
public class LearningModule_Basics extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.learning_module_basics); // Update to your correct XML file for Concept screen
