...
class Model1 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.model_3d_1)
    ...
    private fun initializeViewer() {
        customViewer.run {
            ...
            loadGlb(this@Model1, "sample", "sphere-blue")
            loadIndirectLight(this@Model1, "venetian_crossroads_2k")
        }
    }
