...
public class LearningModule_Ruthford extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.learning_module_ruthford); // Update to your correct XML file for Concept screen
