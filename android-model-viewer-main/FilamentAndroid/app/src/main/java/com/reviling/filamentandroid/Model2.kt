...
class Model2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.model_3d_2)
    ...
    private fun initializeViewer() {
        customViewer.run {
            ...
            loadGlb(this@Model2, "sample", "plum_model")
            loadIndirectLight(this@Model2, "venetian_crossroads_2k")
        }
    }
