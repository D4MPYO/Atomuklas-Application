...
public class LearningModule_Bohr extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.learning_module_bohr); // Update to your correct XML file for Concept screen
