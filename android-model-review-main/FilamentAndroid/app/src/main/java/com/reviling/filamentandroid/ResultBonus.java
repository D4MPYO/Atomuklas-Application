...
public class ResultBonus extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_result_bonus);
        ...
        if (correctAnswers == totalQuestions && totalQuestions != 0) {
            imageView5.setImageResource(R.drawable.badge_bonus); // optional trophy image
            ...
            badgeEditor.putBoolean("badge_bonus_unlocked", true);
            badgeEditor.apply();
        ...
        int highestCorrectAnswers = sharedPreferences.getInt("highestCorrectAnswersBonus", 0);
        int highestTotalQuestions = sharedPreferences.getInt("highestTotalQuestionsABonus", 0);
...
// Check if the current score is higher, and only update if true
        if (correctAnswers > highestCorrectAnswers ||
            ...
            editor.putInt("highestCorrectAnswersBonus", correctAnswers);
            editor.putInt("highestTotalQuestionsBonus", totalQuestions);
            editor.apply();
        }
    ...
    private void setupButtonListeners(int correctAnswers, int wrongAnswers, String timeSpent) {
        backHomeButton.setOnClickListener(v -> {
            startActivity(new Intent(ResultBonus.this, MainActivity.class));
            finish();
        });
        ...
        reviewAnswer.setOnClickListener(v -> {
            if (getIntent().hasExtra("questions") &&
                ...
                Intent reviewIntent = new Intent(ResultBonus.this, ReviewAnswersActivityEasy.class);
